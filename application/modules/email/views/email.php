                                        ...
                                        foreach ($sents as $sent) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td><?php
                                                    ...
                                                    ?></td>
                                                <td>
                                                    <a class="btn btn-info btn-xs btn_width delete_button" href="email/delete?id=<?php echo $sent->id; ?>" <?php echo lang('delete'); ?> onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"> </i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
