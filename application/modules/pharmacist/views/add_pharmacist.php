            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Pharmacist</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="pharmacist/addNewPharmacist" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                if (!empty($pharmacist->password)) {
                                    echo $pharmacist->password;
                                }
                                ?>'>
                            </div>                
                            <div class="form-group">
